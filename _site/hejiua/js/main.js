...
(function () {
	...
	game.qp_e = function () {
		...
		for (var a = [], b = 0; 10 > b; b++) {
			a[2 * b] = a[2 * b + 1] = b*Math.randomInt(29)%29+1;
		    //a[2 * b] = a[2 * b + 1] = 8;
		}
		a.shuffle();
		game.gv.setupCard(a);
...
(function () {
	...
	memory.Qp_m = function () {
		...
		this.setupCard = function (a) {
			for (var b = 0; b < a.length; b++) {
				var c = parseInt(b / memory.qp_k);
				c = new memory.Qp_n(c, b % memory.qp_k, a[b]);
				this.addChild(c);
			}
		};
	...
	memory.Qp_i = function () {
		...
		l.alpha = 0.8;
		var i = new createjs.Bitmap(game.qp_a("happy"));
		i.regX = 325;
		i.regY = 192;
		i.x = 420;
		i.y = 850;
		var j = new createjs.Text("清华2009.核92班八周年纪念", "bold 48px Arial", "#515151");
		j.x = 10
		j.y = 590;
		this.addChild(l, a, b, c, d, e, f, g, h, i, j);
...
function loadResource() {
	...
	queue.loadManifest({path:RES_DIR + "img/", manifest:[{src:"1.jpg", id:"1"}, {src:"2.jpg", id:"2"}, {src:"3.jpg", id:"3"}, {src:"4.jpg", id:"4"}, {src:"5.jpg", id:"5"}, {src:"6.jpg", id:"6"}, {src:"7.jpg", id:"7"},{src:"8.jpg", id:"8"},{src:"9.jpg", id:"9"},{src:"10.jpg", id:"10"},{src:"11.jpg", id:"11"},{src:"12.jpg", id:"12"},{src:"13.jpg", id:"13"},{src:"14.jpg", id:"14"},{src:"15.jpg", id:"15"},{src:"16.jpg", id:"16"},{src:"17.jpg", id:"17"},{src:"18.jpg", id:"18"},{src:"19.jpg", id:"19"},{src:"20.jpg", id:"20"},{src:"21.jpg", id:"21"},{src:"22.jpg", id:"22"},{src:"23.jpg", id:"23"},{src:"24.jpg", id:"24"},{src:"25.jpg", id:"25"},{src:"26.jpg", id:"26"},{src:"27.jpg", id:"27"},{src:"28.jpg", id:"28"},{src:"29.jpg", id:"29"},{src:"frame.png", id:"frame"}, {src:"back.png", id:"back"}, {src:"ready.png", id:"ready"}, {src:"go.png", id:"go"}, {src:"bg.png", id:"bg"}, {src:"topline.png", id:"topline"}, {src:"happy.png", id:"happy"},{src:"bestscore.png", id:"bestscore"}, {src:"curscore.png", id:"curscore"}, {src:"gameover.png", id:"gameover"}, {src:"replaybtn.png", id:"replaybtn"}, {src:"sharebtn.png", id:"sharebtn"}, {src:"toplistbtn.png", id:"toplistbtn"}]}, !1);
